...
// Estilo principal da página (Contêiner Layout)
// Removidas as dimensões (width, height, overflow) para controle externo.
...
// Estilo para o contêiner de seleção e gerenciamento
export const ControlesSelecao = styled.div`
    ...
    /* Estilo para a linha de Seleção de Empresa/Venda */
    .linha-selecao {
        display: flex;
        gap: 30px;
    ...
    /* Estilos do Formulário de Cadastro (Grid) */
    .formulario-empresa {
        display: grid;
...
// Estilo para o visualizador do cupom
...
// Estilo que imita o papel do cupom fiscal
